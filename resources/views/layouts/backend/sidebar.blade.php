...
{{--            <!-- menu item Dashboard-->--}}
{{--            <li>--}}
{{--                <a data-target="#dashboard" data-toggle="collapse" href="javascript:void(0);">--}}
{{--                    <div class="pull-left"><i class="ti-home"></i><span--}}
{{--                            class="right-nav-text">Dashboard</span></div>--}}
{{--                    <div class="pull-right"><i class="ti-plus"></i></div>--}}
{{--                    <div class="clearfix"></div>--}}
{{--                </a>--}}
{{--                <ul class="collapse" data-parent="#sidebarnav" id="dashboard">--}}
...
{{--            <!-- menu title -->--}}
            ...
            <li>
                <a href="{{ route('admin.dashboard.index') }}"><i class="ti-home"></i>
            ...
            <li>
                ...
                <ul class="collapse" data-parent="#sidebarnav" id="categories">
            ...
            <!-- menu item Elements-->
            <li>
                <a data-target="#elements" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-palette"></i><span
                            class="right-nav-text">Elements</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="elements">
            ...
            <!-- menu item calendar-->
            <li>
                <a data-target="#calendar-menu" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-calendar"></i><span
                            class="right-nav-text">calendar</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="calendar-menu">
            ...
            <!-- menu item chat-->
            <li>
                <a href="chat-page.html"><i class="ti-comments"></i><span
                        class="right-nav-text">Chat </span></a>
            </li>
            <!-- menu item mailbox-->
            <li>
                <a href="mail-box.html"><i class="ti-email"></i><span
                        class="right-nav-text">Mail box</span>
                    <span class="badge badge-pill badge-warning float-right mt-1">HOT</span> </a>
            </li>
            <!-- menu item Charts-->
            <li>
                <a data-target="#chart" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-pie-chart"></i><span
                            class="right-nav-text">Charts</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="chart">
            ...
            <!-- menu font icon-->
            <li>
                <a data-target="#font-icon" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-home"></i><span
                            class="right-nav-text">font icon</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="font-icon">
            ...
            <!-- menu item Form-->
            <li>
                <a data-target="#Form" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-files"></i><span class="right-nav-text">Form & Editor</span>
                    </div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="Form">
            ...
            <!-- menu item table -->
            <li>
                <a data-target="#table" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-layout-tab-window"></i><span
                            class="right-nav-text">data table</span>
                    </div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="table">
            ...
            <li>
                <a data-target="#custom-page" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-file"></i><span
                            class="right-nav-text">Custom pages</span></div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="custom-page">
            ...
            <li>
                <a data-target="#authentication" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-id-badge"></i><span class="right-nav-text">Authentication</span>
                    </div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="authentication">
            ...
            <li>
                <a data-target="#multi-level" data-toggle="collapse" href="javascript:void(0);">
                    <div class="pull-left"><i class="ti-layers"></i><span class="right-nav-text">Multi level Menu</span>
                    </div>
                    <div class="pull-right"><i class="ti-plus"></i></div>
                    <div class="clearfix"></div>
                </a>
                <ul class="collapse" data-parent="#sidebarnav" id="multi-level">
                    <li>
                        <a data-target="#auth" data-toggle="collapse" href="javascript:void(0);">Level
                            item
                            1
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        ...
                        <ul class="collapse" id="auth">
                            <li>
                                <a data-target="#login" data-toggle="collapse"
                                   href="javascript:void(0);">Level
                                    item 1.1
                                    <div class="pull-right"><i class="ti-plus"></i></div>
                                    <div class="clearfix"></div>
                                </a>
                                <ul class="collapse" id="login">
                                    <li>
                                        <a data-target="#invoice" data-toggle="collapse"
                                           href="javascript:void(0);">level item 1.1.1
                                            <div class="pull-right"><i class="ti-plus"></i></div>
                                            <div class="clearfix"></div>
                                        </a>
                    ...
                    <li>
                        <a data-target="#error" data-toggle="collapse" href="javascript:void(0);">level
                            item
                            2
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul class="collapse" id="error">
